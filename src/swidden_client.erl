...
request_with_headers(Port, Headers, Target, Service, Version, Operation, Json) ->
    request0(Port, Headers, Target, Service, Version, Operation, Json).
...
request0(RawPort, Headers, Target, Service, Version, Operation, RawJson) ->
    URL = <<"http://127.0.0.1", $:, RawPort/binary, $/>>,
    Headers = [{Target, list_to_binary([Service, $_, Version, $., Operation])}|Headers],
    Options = [{pool, false}],
